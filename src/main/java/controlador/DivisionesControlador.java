...
public class DivisionesControlador {
    ...
    private void abrirDialogoCrear() {
        CrearModificarDivisionDialogVista dialogo = new CrearModificarDivisionDialogVista(false);
        new CrearModificarDivisionControlador(dialogo, null, usuarioActual, this);
    ...
    private void abrirDialogoEditar() {
        ...
        CrearModificarDivisionDialogVista dialogo = new CrearModificarDivisionDialogVista(true);
        new CrearModificarDivisionControlador(dialogo, divisionCompleta, usuarioActual, this);
        dialogo.setVisible(true);
    }
    ...
    private void abrirGestionMiembros() {
        ...
        GestionarMiembrosDivisionDialogVista dialogo = new GestionarMiembrosDivisionDialogVista(divisionSeleccionada.getNombre());
        new GestionarMiembrosDivisionControlador(dialogo, divisionSeleccionada.getIdDivision(), usuarioActual, this);
        dialogo.setVisible(true);
    }
